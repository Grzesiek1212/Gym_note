                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildBodyMeasurementRow(context, 'Klatka piersiowa',
                        '${data['klatka_piersiowa']}'),
                    _buildBodyMeasurementRow(context, 'Biceps', '${data['biceps']}'),
                    _buildBodyMeasurementRow(context, 'Przedramię', '${data['przedramię']}'),
                    _buildBodyMeasurementRow(context, 'Brzuch', '${data['brzuch']}'),
                    _buildBodyMeasurementRow(context, 'Biodra', '${data['biodra']}'),
                    _buildBodyMeasurementRow(context, 'Uda', '${data['uda']}'),
                    _buildBodyMeasurementRow(context, 'Łydka', '${data['łydka']}'),
                    const SizedBox(height: 16),
