...
class ExerciseGridWidget extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> exercises = [
    ...
    {'name': 'Przedramię', 'image': 'assets/forearm.png'},
    {'name': 'Udo tylnie i pośladki', 'image': 'assets/legs.png'},
    {'name': 'Brzuch', 'image': 'assets/abs.png'},
    {'name': 'Łydka', 'image': 'assets/calf.png'},
    {'name': 'Udo przednie', 'image': 'assets/frontlegs.png'},
