...
class SaveEditMeasurementsButtonWidget extends StatelessWidget {
  final String? selectedDate;
  final Map<String, TextEditingController> controllers;
  final ProfileMeasurementService profileService;

  const SaveEditMeasurementsButtonWidget({
    Key? key,
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          try {
            await profileService.updateMeasurements(
              date: selectedDate!,
